...
class DigitalTwinChat:
    ...
    def _setup_paths(self):
        ...
        self.prompts_dir = self.project_root / "prompts" / "dt_shared"
    ...
    def _load_data(self):
        ...
        shared_prompt_file = self.prompts_dir / "shared_prompt.txt"
        ...
        # Generated by scripts/cohort_generation/02_baseline_profiles.py
        ...
        # Generated by scripts/enrich_memory/05_enrich_profiles_and_conversations.py
        enriched_file = self.data_dir / "enriched_profiles_final.json"
        with open(enriched_file, 'r', encoding='utf-8') as f:
            data = json.load(f)
            # enriched_profiles_final.json is a list at top level
            records = data if isinstance(data, list) else data.get('enrichments', [])
            self.enriched_profiles = {e['student_id']: e for e in records}
